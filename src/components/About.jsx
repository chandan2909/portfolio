        ...
        <section id="about" className="py-20 animate-on-scroll">
            <div className="container mx-auto max-w-6xl px-8">
                <div className="mb-16">
                    ...
                    <h2 className="text-6xl lg:text-8xl font-black text-black dark:text-white uppercase tracking-tighter leading-none">
                        About Me
                    </h2>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-white dark:bg-dark-200 rounded-3xl p-10 border border-gray-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-all duration-500 group">
                        <div className="flex items-center mb-8">
                            ...
                            <h3 className="text-black dark:text-white font-black text-3xl uppercase tracking-tighter">My Journey</h3>
                        </div>
                    ...
                    <div className="bg-white dark:bg-dark-200 rounded-3xl p-10 border border-gray-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-all duration-500 group">
                        <div className="flex items-center mb-8">
                            ...
                            <h3 className="text-black dark:text-white font-black text-3xl uppercase tracking-tighter">My Drive</h3>
                        </div>
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg font-medium">
