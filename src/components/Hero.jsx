                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-10">
                    <div className="lg:w-1/2 text-left space-y-8">
                        <div className="space-y-3">
                            <h1 className="text-7xl lg:text-8xl font-black text-black dark:text-white leading-[0.85] tracking-tighter uppercase whitespace-pre-line">
                                Chandan{"\n"}Pathak
                            </h1>
                            <div className="pt-4">
                                <p className="text-xl lg:text-2xl font-bold text-black dark:text-white min-h-[1.5em] flex items-center">
                                    {typedText}
                                    <span className="animate-pulse inline-block w-0.5 h-6 bg-black dark:bg-white ml-1"></span>
                                </p>
                        ...
                        <div className="flex flex-wrap gap-4 pt-2">
                            <a
                                ...
                                className="p-4 bg-white dark:bg-dark-200 border border-gray-100 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-dark-300 rounded-full transition-all duration-300 shadow-sm group"
